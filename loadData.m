...
if CargarMatrices
    ...
    load([fullfile(mfilepath,'../GeneralData/mats/TopBottom/Positions/') 'positionsMatrix.mat'], 'positionsMatrix');%load('positionsMatrix.mat', 'positionsMatrix');
    load([fullfile(mfilepath,'../GeneralData/mats/TopBottom/Positions/') 'positionsNameMap.mat'], 'positionsNameMap');%load('positionsNameMap.mat', 'positionsNameMap');
...
if ~exist('MaxNroIterIf', 'var')
   MaxNroIterIf = 25000; %cuántos cálculos de radiosidad realiza? 
end
cppit = 10;
